...
namespace Capa_Negocios
{
    public class MantenimientoEntidades
    {
        ...
        public Entidades CrearObjeto(int id, string descripcion, string direccion, string localidad, string tipoEntidad, string tipoDoc, string numeroDoc, string telefono, int idGrupoEntidad, int idTipoEntidad, int LimiteCredito, string userName, string Pass, string rol, string Status, int eliminable, DateTime fecha)
        {
